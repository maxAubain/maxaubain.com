  ...
  return (
    <div className="section-profile feature-profile">
      <div className="feature-description">
        ...
        <p>
          Max is thorough and is very good at precise, complex, detail oriented
          work. The work he delivers and manages through others is high quality,
          even in fast paced, constantly changing and high pressure
          environments. Max communicates with others and makes decisions with
          the calm and level headnesses of someone who has months to reason
          through things, while easily making decisions quickly and with limited
          information.
        </p>
